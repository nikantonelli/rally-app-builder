...
let rawDebugName = "raw-debug.html";
let rawName = "raw.html";
...
let buildDeployFiles = function({appPath, templateData, rawName, rawDebugName, appFileName, appExternalFileName, appDebugFileName, appUncompressedFileName }, callback){
  let templateBase = templateData.templates;
  return async.forEach(
    [
      {templateFileName: rawDebugName, directory: '.'},
      {templateFileName: appDebugFileName, directory: '.'},
      {templateFileName: rawName, directory: deployFilePath},
...
//exports constants
_.defaults(module.exports, {configFileName: configModule.configFileName, rawName, rawDebugName, appFileName, deployFilePath, appDebugFileName, appUncompressedFileName, appExternalFileName, runScript, runBuild});
